...
{
    /// <summary>
    /// Tool for modifying serialized properties of any UnityEngine.Object.
    /// </summary>
    public class ObjectModifyTool : McpToolBase
    {
        public ObjectModifyTool()
        {
            Name = "object_modify";
            Description = "Modifies serialized properties of any UnityEngine.Object by instance ID.";
        }
        ...
        public override JObject Execute(JObject parameters)
        {
            try
            {
                ...
                McpLogger.LogInfo($"Modified {modifiedCount}/{requestedCount} serialized propertie(s) on object '{unityObject.name}'");
                ...
                return new JObject
                {
                    ["success"] = true,
                    ["type"] = "text",
                    ["message"] = $"Modified {modifiedCount}/{requestedCount} serialized propertie(s) on object '{unityObject.name}'",
            ...
            {
                return McpUnitySocketHandler.CreateErrorResponse(
                    $"Error modifying object: {ex.Message}",
                    "object_modify_error"
                );
            }
        }
        ...
        private static bool IsBuiltInAsset(string assetPath)
        {
            ...
            return assetPath.StartsWith("Resources/unity_builtin_extra", StringComparison.Ordinal) ||
                   assetPath.StartsWith("Library/unity default resources", StringComparison.Ordinal);
        }
        ...
        private static bool TrySetSerializedPropertyValue(SerializedProperty serializedProperty, JToken valueToken)
        {
            ...
            switch (serializedProperty.propertyType)
            {
                ...
                case SerializedPropertyType.Float:
                    serializedProperty.doubleValue = valueToken.ToObject<double>();
                    return true;
